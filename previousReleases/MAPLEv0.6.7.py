...
def stringForNode(tree,nextNode,nameNode,dist,estimateMAT=estimateMAT,networkOutput=networkOutput,aBayesPlusOn=aBayesPlusOn,namesInTree=None):
	children=tree.children
	up=tree.up
	dist=tree.dist
	name=tree.name
