...
#TODO Models of sequencing errors
...
#longer-term plans
#TODO codon models, indels
#TODO Timed trees
#TODO Bayesian implementation in BEAST
#TODO Recombination

#things one could maybe also do in future:
...
parser.add_argument('--inputTree',default="", help='input newick tree file name; this is optional, and is used for online inference (not implemented yet) and for Robinson-Foulds distance calculation.')
...
def readNewick(nwFile,multipleTrees=False):
