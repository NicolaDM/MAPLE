...
parser.add_argument('--input',default="/Users/demaio/Desktop/GISAID-hCoV-19-phylogeny-2021-03-12/phylogenetic_inference/2021-03-31_unmasked_differences_reduced.txt_consensus-based.txt", help='input MAPLE file name.')
parser.add_argument('--reference',default="", help='input reference file name. By default it assumes that the reference is part of the MAPLE format input.')
